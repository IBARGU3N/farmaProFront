  ...
  return (
    <div className="p-6 bg-[#DAFFED]/20 min-h-screen">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-black text-[#473198]">Usuarios</h1>
          <p className="text-[#473198]/60 mt-1">Gestion de usuarios y roles</p>
        </div>
      ...
      {showForm && (
        <Card className="p-6 mb-6">
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-bold text-[#473198] mb-1">
            ...
            <div>
              <label className="block text-sm font-bold text-[#473198] mb-1">Rol *</label>
              <select
                value={formData.rol}
            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-[#9BF3F0]/10">
                {users.length > 0 ? users.map((u) => (
                  <tr key={u.id} className="hover:bg-[#DAFFED]/30 transition-colors">
                    <td className="px-6 py-4 font-bold text-[#473198]">{u.name}</td>
                    <td className="px-6 py-4 text-sm text-[#473198]/60">{u.email}</td>
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <button onClick={() => handleEdit(u)} className="p-1.5 text-[#473198]/50 hover:text-[#473198] transition-colors" title="Editar">
                  ...
                  <tr>
                    <td colSpan="4" className="px-6 py-12 text-center text-[#473198]/40">
